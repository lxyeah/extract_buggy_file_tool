...
if __name__ == '__main__':
    ...
    false_positive_reports_path = './false_positive_reports/unfixed-{}.csv'.format(pro_name)
    with open(false_positive_reports_path, 'r') as f:
        reader = csv.reader(f)
        i = 0
        for line in reader:
            if i == 0:
    ...
    check_dir = pro_name + "_unfixed_check"
    ...
    with open(false_positive_reports_path, 'r') as f:
        ...
        for line in reader:
            if i == 0:
                ...
                warning_dir = os.path.join(warning_root_dir, 'unfixed_warning_' + str(i))
